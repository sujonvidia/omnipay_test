...
import { LuSparkles, LuHistory } from 'react-icons/lu'
...
export default function FinanceLayout() {
    ...
    return (
        <div className={`app w-full h-full${sidebarExpanded ? ' sidebar-expanded' : ''}`}>
        <FinanceSidebar expanded={sidebarExpanded} onToggle={toggleSidebar} />
        <div className='main w-full h-full'>
            ...
            <div className='page w-full h-[calc(100%-56px)]'>
                <Outlet />
            </div>
